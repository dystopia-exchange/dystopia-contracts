...
async function main() {
  ...
  const factory = await Deploy.deployBaseV1Router01(signer,core.address, "0xe02f20BB33F8Bfb48eB907523435CA886e139A08");
  ...
  await Deploy.verifyWithArgs(factory.address, [core.address, "0xe02f20BB33F8Bfb48eB907523435CA886e139A08"]);
