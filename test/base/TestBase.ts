...
//     ust =  await Deploy.deployToken(owner,'ust', 'ust', 6)
...
//     mim = await Deploy.deployToken(owner,'MIM', 'MIM', 18);
...
//     dai = await Deploy.deployToken(owner,'DAI', 'DAI', 18);
...
//     ve_underlying =await Deploy.deployBaseV1(owner);
...
//     late_reward = await Deploy.deployToken(owner,'LR', 'LR', 18);
//     await late_reward.mint(owner.address, ethers.BigNumber.from("20000000000000000000000000"));
//     ve = await Deploy.deployVe(owner,ve_underlying.address);
//     await ust.deployed();
//     await mim.deployed();
//   });
...
//     factory =await Deploy.deployBaseV1Factory(owner);
...
//     router =await Deploy.deployBaseV1Router01(owner,factory.address, owner.address);
...
//     gauges_factory = await Deploy.deployGaugeFactory(owner);
//     await gauges_factory.deployed();
//     const bribe_factory = await Deploy.deployGaugeFactory(owner);
//     await bribe_factory.deployed();
//     gauge_factory = await Deploy.deployBaseV1Voter(owner,ve.address, factory.address, gauges_factory.address, bribe_factory.address);
...
//     ve_dist = await Deploy.deployVeDist(owner,ve.address);
//     await ve_dist.deployed();
//     minter = await Deploy.deployBaseV1Minter(owner,gauge_factory.address, ve.address, ve_dist.address);
...
//     staking = await Deploy.deployStakingRewards(owner,pair.address, ve_underlying.address)
...
//     let root = await Deploy.deployRoots(owner,metadata.dec0, metadata.dec1, metadata.st, metadata.t0, metadata.t1);
//     await root.deployed();
